import 'package:examy/cubits/ideal_exam_cubit/ideal_exam_cubit.dart';
...
class IdealExamScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context)=> IdealExamCubit()..getQuestionsData(sessionName: sessionName, dayName: dayName, groupName: groupName, examName: examName),
          ...
          child: ListView.separated(
              ...
              itemBuilder: (context,answerIndex){
                return answerBuilder(
                    ...
                    cubit: cubit,
                    isCorrect: answerIndex+1 == cubit.questions[(index+1).toString()]!['correctAnswerNumber'] ? true : false,
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: image == null ? BoxDecoration(
                      border: Border.all(
                        color: isCorrect ?  Colors.green : whiteCl,
                        width: 3.w,
